...
from aegis_experimentation.models import ExperimentDefinition, ExperimentRun, ExperimentStatus
...
class ExperimentRegistry:
    ...
    async def create_run(self, experiment_id: uuid.UUID, workflow_run_ids: list[uuid.UUID]) -> ExperimentRun:
