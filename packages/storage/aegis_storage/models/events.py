...
class RawEvent(Base):
    ...
    payload: Mapped[dict[str, Any]] = mapped_column(SQLiteCompatibleJSONB, nullable=False)
...
class NormalizedEvent(Base):
    ...
    data: Mapped[dict[str, Any]] = mapped_column(SQLiteCompatibleJSONB, nullable=False)
